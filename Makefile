...
SRC = 	$(SRC_DIR)/ft_shell.c $(PARSING)/parser_utilis.c $(PARSING)/tokenizer_check.c $(PARSING)/tokenizer.c  $(PARSING)/parser.c $(TOOLS)/cmd_lst.c $(PARSING)/tokenizer_utilis.c $(PARSING)/tokenizer_utilis2.c $(PARSING)/syntax_errors.c $(PARSING)/parcer2.c $(ENV)/env_list.c $(EXEC)/env_sort.c $(EXEC)/built_ins.c\
