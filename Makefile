...
#    Updated: 2022/09/24 05:34:20 by zrabhi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSING    := final_check parser_utils  parser parser2 parser3 syntax_errors tokenizer_utils tokenizer_utils2 tokenizer var_expander here_doc
src        := ft_shell
