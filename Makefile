...
#    Updated: 2022/09/27 02:27:38 by aelyakou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSING    := final_check parser_utils  parser parser2 parser3  free_list syntax_errors tokenizer_utils tokenizer_utils2 tokenizer var_expander here_doc
src        := ft_shell
