...
#    Updated: 2022/09/21 21:44:17 by zrabhi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSING    := final_check parser4 parser_utils  parser parser2 parser3 syntax_errors tokenizer_check tokenizer_utils tokenizer_utils2 tokenizer  var_expander here_doc
src        := ft_shell
